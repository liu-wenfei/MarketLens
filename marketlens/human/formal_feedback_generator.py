...
FORMAL_GENERATOR_CONTRACT_VERSION = (
    "marketlens-formal-feedback-generator-v12"
)
FORMAL_GENERATOR_ID = (
...
def _corrective_retry_user_prompt(
    *,
    ...
    return (
        ...
        + "request.\n"
        + "Regenerate the complete response while preserving every "
        + "original MarketLens constraint. The new response must satisfy "
        + "ALL of the following rules, regardless of which single rule "
        ...
        + "If the validator reason is prescriptive or optimisation "
        + "language, rewrite the reflection as retrospective description "
        + "only. Do not use: moving forward, going forward, aim to, "
        + "aiming to, try to, trying to, potential edge, risk management, "
        + "investment strategy, trading strategy, disciplined, or "
        + "discipline.\n"
        + "If the validator reason is unsupported psychological, "
        + "attentional, intentional, or strategic attribution, remove "
        + "all inferred internal states. Describe only observable recorded "
        + "judgement, confidence, participant-reported rationale/evidence, "
        + "and trade/no-trade behaviour. Do not infer preference, reliance, "
        + "emphasis, patience, motivation, intention, attention, strategy, "
        + "risk posture, monitoring, caution, deliberateness, or similar "
        + "states. Avoid constructions such as the pattern suggests, "
        + "this indicates, this implies, this reflects, this shows, "
        + "this reveals, this points to, this hints at, this appears to, "
        + "this may suggest, this may indicate, or this may reflect when "
        + "they attribute an internal state. Preserve explicitly reported "
        + "state labels rather than replacing them with neutral stance, "
        + "cautious stance, cautious progression, measured approach, or "
        + "another unreported label.\n"
        + "If the validator reason is ambiguous assessment/trade terminology, "
        + "do not use action or actions. Use assessment, judgement, or stated "
        + "view for the recorded BUY/HOLD/SELL assessment, and use trade, "
        + "transaction, no trade, or portfolio behaviour only for actual "
        + "portfolio behaviour.\n"
        + "If the validator reason is malformed participant-facing spacing, "
        + "rewrite with normal English spacing between every sentence and word.\n"
