    ...
    return [
        {
            ...
            "submitted_at": f"{DATES[0]}T12:00:00+00:00",
            "stock_id": "TLEI",
            "action": "HOLD",
            "confidence": 70.0,
            "evidence_sources": "[]",
        ...
        },
        {
            ...
            "submitted_at": f"{DATES[7]}T12:00:00+00:00",
            "stock_id": "TLEI",
            "action": "BUY",
            "confidence": 55.0,
            "evidence_sources": "[]",
        ...
        },
        {
            ...
            "submitted_at": f"{DATES[14]}T12:00:00+00:00",
            "stock_id": "TLEI",
            "action": "SELL",
            "confidence": 45.0,
            "evidence_sources": "[]",
...
def _transactions():
    return [
        ...
        },
        {
            ...
            "executed_notional": 48.0,
            "requested_amount": 48.0,
            "requested_units": 2.0,
            "executed_units": 2,
            "fee": 0.0,
            "price_date": DATES[4],
        ...
        },
        {
            ...
            "executed_notional": 34.0,
            "requested_amount": 34.0,
            "requested_units": 2.0,
            "executed_units": 2,
            "fee": 0.0,
            "price_date": DATES[7],
